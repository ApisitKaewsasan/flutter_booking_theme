...
class CompletedTablet extends StatefulWidget {
  @override
  _CompletedTabletState createState() => _CompletedTabletState();
}

class _CompletedTabletState extends State<CompletedTablet> {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(LocaleKeys.mybooking_rateout.tr(),
                              style: GoogleFonts.kanit(
                                  fontSize: 12, fontWeight: FontWeight.w300,color: ThemeColor.fontprimaryColor(context))),
                      ...
                      ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: FlatButton(
                            ...
                            color: ThemeColor.secondaryColor(context),
                            onPressed: () {
                              Navigator.push(context, PageTransition(duration: Duration(milliseconds: 300),type: PageTransitionType.fade, child: BookingView(titiletag: "titletag_$index",imagetag: "imagetag_$index")));
                            },
