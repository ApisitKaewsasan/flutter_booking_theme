...
class StartUpTablet extends StatefulWidget {
  static const String PATH = '/startup';

  @override
  _StartUpTabletState createState() => _StartUpTabletState();
}

class _StartUpTabletState extends State<StartUpTablet> with RouteAware{
