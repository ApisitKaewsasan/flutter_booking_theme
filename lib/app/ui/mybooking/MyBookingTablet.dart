...
class MyBookingTablet extends StatefulWidget {
  static const String PATH = '/mybooking';
  @override
  _MyBookingTabletState createState() => _MyBookingTabletState();
}

class _MyBookingTabletState extends State<MyBookingTablet> with SingleTickerProviderStateMixin{
