...
class CreateNewPasswordMobile extends StatefulWidget {
  @override
  _CreateNewPasswordMobileState createState() => _CreateNewPasswordMobileState();
}

class _CreateNewPasswordMobileState extends State<CreateNewPasswordMobile> {
