...
class _EditProfileMobileState extends State<EditProfileMobile> {
  ...
  void _validate() {
    if(_name.text.isEmpty || _email.text.isEmpty || _phone.text.isEmpty){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.profile_please_fill_out_all_information.tr(),onPressed: (){});
    }else if(!validator.email(_email.text)){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.profile_email_incorrect_format.tr(),onPressed: (){});
    }else if(_phone.text.length<10){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.profile_invalid_phone_number.tr(),onPressed: (){});
    }else{
