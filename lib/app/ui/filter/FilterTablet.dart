...
class FilterTablet extends StatefulWidget {

  static const String PATH = '/filter';
  @override
  _FilterTabletState createState() => _FilterTabletState();
}


class _FilterTabletState extends State<FilterTablet> with RouteAware{
