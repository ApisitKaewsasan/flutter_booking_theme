...
class FilterMobile extends StatefulWidget {
  ...
  @override
  _FilterMobileState createState() => _FilterMobileState();
}


class _FilterMobileState extends State<FilterMobile> with RouteAware{
  ...
  Widget content(Filter filter){
    return ListView(
      children: [
        SizedBox(height: 15,),
        Text(LocaleKeys.select_room_filter.tr(), style: GoogleFonts.kanit(fontSize: 26,fontWeight: FontWeight.w500,color: ThemeColor.fontprimaryColor(context)),),
        SizedBox(height: 15,),
