...
import 'package:ds_book_app/app/ui/page/LanguagePage.dart';
       ...
       body: Container(
         child: SingleChildScrollView(
           child: Column(
             children: [
               SizedBox(height: 10,),
               _menuSetting(context,title: LocaleKeys.setting_language_title.tr(),countMessage: 0,icon: Icons.settings,page: LanguagePage()),
