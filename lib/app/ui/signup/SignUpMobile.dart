...
class _SignUpMobileState extends State<SignUpMobile> with RouteAware{
  ...
  void _validate() {
    ...
    if(_phone.text.isEmpty ){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.reset_pass_email_phone_Empty.tr(),onPressed: (){});
    }else if(_phone.text.length<10){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.signinsignup_phone_incorrect_format.tr(),onPressed: (){});
    }else{
