...
class PaymentDetailsMobile extends StatefulWidget {
  static const String PATH = '/paymentdetail';
  @override
  _PaymentDetailsMobileState createState() => _PaymentDetailsMobileState();
}

class _PaymentDetailsMobileState extends State<PaymentDetailsMobile> {
