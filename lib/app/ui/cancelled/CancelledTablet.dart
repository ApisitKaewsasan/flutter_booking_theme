...
class CancelledTablet extends StatefulWidget {
  @override
  _CancelledTabletState createState() => _CancelledTabletState();
}

class _CancelledTabletState extends State<CancelledTablet> {
