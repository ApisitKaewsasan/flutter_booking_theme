...
class CancelledMobile extends StatefulWidget {
  @override
  _CancelledMobileState createState() => _CancelledMobileState();
}

class _CancelledMobileState extends State<CancelledMobile> {
