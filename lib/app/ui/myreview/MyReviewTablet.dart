...
class MyReviewTablet extends StatefulWidget {

  static const String PATH = '/myreview';
  @override
  _MyReviewTabletState createState() => _MyReviewTabletState();
}

class _MyReviewTabletState extends State<MyReviewTablet> {
