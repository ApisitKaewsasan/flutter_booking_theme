...
class _ChangePasswordMobileState extends State<ChangePasswordMobile> {
  ...
  void _validate() {
    ...
    if(_oldpassword.text.isEmpty && _newpassword.text.isEmpty && _confirmpassword.text.isEmpty){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.changepassword_information_not_available.tr(),onPressed: (){});
    }else if(_newpassword.text == _confirmpassword.text.isEmpty){
      FunctionHelper.SnackBarShow(scaffoldKey: _scaffoldKey,context: context,message: LocaleKeys.changepassword_passwords_do_not_match.tr(),onPressed: (){});
    }else{
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(LocaleKeys.changepassword_title.tr(),style: GoogleFonts.kanit(color: ThemeColor.secondaryColor(context),fontSize: 26)),
                      SizedBox(height: 20),
                      _formInput(),
                      SizedBox(height: 15),
                      Container(
