...
class BookingTablet extends StatefulWidget {
  static const String PATH = '/booking';

  final titiletag;
  final imagetag;

  const BookingTablet({Key key, this.titiletag, this.imagetag}) : super(key: key);

  @override
  _BookingTabletState createState() => _BookingTabletState();
}

class _BookingTabletState extends State<BookingTablet> {
  int Extrabed = 0;
  int Refrigerator = 0;
  int Microwave = 0;
