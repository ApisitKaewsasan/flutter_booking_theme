...
import 'package:ds_book_app/app/ui/editprofile/EditProfileView.dart';
import 'package:ds_book_app/app/ui/mybooking/MyBookingView.dart';
import 'package:ds_book_app/app/ui/myreview/MyReviewView.dart';
import 'package:ds_book_app/app/ui/mysave/MySaveView.dart';
import 'package:ds_book_app/app/ui/notification/NotificationView.dart';
import 'package:ds_book_app/app/ui/setting/SettingView.dart';
              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    _menuProfile(title: LocaleKeys.profile_my_booking.tr(),countMessage: 1,icon: Ionicons.ios_bed,page: MyBookingView()),
                    Divider(color: Color(ColorUtils.hexToInt("#C5C5C5"))),
                    _menuProfile(title: LocaleKeys.profile_saved.tr(),countMessage: 0,icon: Icons.bookmark,page: MySaveView()),
                    Divider(color: Color(ColorUtils.hexToInt("#C5C5C5"))),
                    _menuProfile(title:LocaleKeys.profile_notification.tr(),countMessage: 20,icon: Icons.notifications,page: NotificationView()),
                    Divider(color: Color(ColorUtils.hexToInt("#C5C5C5"))),
                    _menuProfile(title: LocaleKeys.profile_my_review.tr(),countMessage: 15,icon: Icons.star,page: MyReviewView()),
                    Divider(color: Color(ColorUtils.hexToInt("#C5C5C5"))),
                    _menuProfile(title: LocaleKeys.profile_setting.tr(),countMessage: 0,icon: Icons.settings,page: SettingView()),
                    Divider(color: Color(ColorUtils.hexToInt("#C5C5C5"))),
