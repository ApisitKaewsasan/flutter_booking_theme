...
class RoomDetailMobile extends StatefulWidget {
  static const String PATH = '/roomdetail';

  final titiletag;
  final imagetag;

  const RoomDetailMobile({Key key, this.titiletag, this.imagetag})
      : super(key: key);
...
class _RoomDetailPageState extends State<RoomDetailMobile> with RouteAware {
