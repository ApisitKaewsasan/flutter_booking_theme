...
class ReviewNowMobile extends StatefulWidget {
  ...
  const ReviewNowMobile({Key key, this.titiletag, this.imagetag, this.subtitle}) : super(key: key);

  @override
  _ReviewNowMobileState createState() => _ReviewNowMobileState();
}

class _ReviewNowMobileState extends State<ReviewNowMobile> {
